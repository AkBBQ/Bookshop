...
<div class="panel panel-info">
    <div class="panel-heading">大类列表</div>
    <div class="panel-body">
        <form  class="navbar-form navbar-left" action="tour/list" name="frm" method="post">
            <div class="form-group">
                ...
                <button type="button" class="btn btn-success" onclick="location.href='class/LPreadd'">新增</button>
...
<table class="table table-bordered table-striped table-hover">
    	...
    	<c:forEach items="${list}" var="t" varStatus = "status">
    		<tr>
    			...
    			<td><a href="class/Lpreupdate?id=${t.id}" class="btn btn-success btn-sm">修改</a> 
		        <a href="class/Ldel?id=${t.id}" class="btn btn-success btn-sm">删除</a></td>
    		</tr>
    	</c:forEach>
